  ...
  return (
    <div className="mx-8 sm:mx-16 xl:mx-24 relative">
      <div className="text-center mt-20 mb-8">
        ...
        <p>
          This is where ideas find their voice, where moments become meaning,
          and where every perspective is celebrated. Step in, share freely, and
          let your words spark imagination—here, every story matters and every
          thought is the start of something extraordinary.
        </p>
